                    ...
                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                        ...
                        <div class="ms-3">
                            ...
                            if ($res) {
                                ...
                                echo '<h6 class="mb-0">₹' . $total . '.00</h6>';
                            } else {
                                echo "Something problem occured in our shop.";
                            }
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                        ...
                        <div class="ms-3">
                            ...
                            $sql4 = "SELECT * FROM `orders` WHERE `order_status`='Placed'";
                            $res4 = mysqli_query($conn, $sql4);
                            $num4 = mysqli_num_rows($res4);
                            if ($num4) {
                                echo '<h6 class="mb-0">' . $num4 . '</h6>';
                            } else {
                                if ($num4 == 0) {
                                    echo '<h1 class="mx-2">0</h1>';
                                }
                                echo "<p>some problem occured in our shop</p>";
                            }
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                        ...
                        <div class="ms-3">
                            ...
                            $sql5 = "SELECT * FROM `orders` WHERE `order_status`='cancelled'";
                            $res5 = mysqli_query($conn, $sql5);
                            $num5 = mysqli_num_rows($res5);
                            if ($num5) {
                                echo '<h6 class="mb-0">' . $num5 . '</h6>';
                            } else {
                                echo "<p>some problem occured in our shop</p>";
                            }
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                        ...
                        <div class="ms-3">
                            ...
                            $sql6 = "SELECT * FROM `orders` WHERE `order_status`='pending'";
                            $res6 = mysqli_query($conn, $sql6);
                            $num6 = mysqli_num_rows($res6);
                            if ($num6) {
                                echo '<h6 class="mb-0 text-center">' . $num6 . '</h6>';
                            } else {
                                if ($num6 == 0) {
                                    echo '<h1 class="mx-2">0</h1>';
                                }
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                        ...
                        <div class="ms-3">
                            ...
                            $num3 = mysqli_num_rows($res3);
                            if ($num3) {
                                echo '<h6 class="mb-0 text-center">' . $num3 . '</h6>';
                            } else {
                                echo "<p>some problem occured in our shop</p>";
                            }
